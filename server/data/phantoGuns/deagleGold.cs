...
$MM::LoadedGun_DesertEagleGold = true;

$MM::GunItem[$MM::GunItems] = "DesertEagleGoldItem";
$MM::GunItems++;

datablock ItemData(DesertEagleGoldItem)
{
	...
	//gui stuff
	uiName = "Desert Eagle G";
	iconName = "Add-Ons/Weapon_Gun/icon_gun";
	doColorShift = true;
	colorShiftColor = "1 0.9 0.2 1";

	 // Dynamic properties defined by the scripts
	image = DesertEagleGoldImage;
	canDrop = true;
...
datablock ShapeBaseImageData(DesertEagleGoldImage)
{
   // Basic Item properties
   shapeFile = "./deagle.dts";
   emap = true;
...
function DesertEagleGoldImage::onFire(%this, %obj, %slot)
{
	MMGunImage::onFire(%this, %obj, %slot);
}

function DesertEagleGoldImage::onReady(%this,%obj,%slot)
{
	MMGunImage::onReady(%this, %obj, %slot);
}

function DesertEagleGoldImage::onReloaded(%this, %obj, %slot)
{
	MMGunImage::onReloaded(%this, %obj, %slot);
}

function DesertEagleGoldImage::onReloadStart(%this, %obj, %slot)
{
	MMGunImage::onReloadStart(%this, %obj, %slot);
}

function DesertEagleGoldImage::onReloadMid(%this, %obj, %slot)
{
