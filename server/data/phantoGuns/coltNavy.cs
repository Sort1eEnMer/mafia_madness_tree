...
$MM::LoadedGun_ColtNavy = true;

$MM::GunItem[$MM::GunItems] = "ColtNavyItem";
$MM::GunItems++;

datablock ItemData(ColtNavyItem)
{
	category = "Weapon";  // Mission editor category
	className = "Weapon"; // For inventory system

	 // Basic Item Properties
	shapeFile = "./coltnavy.dts";
	rotate = false;
	mass = 1;
	density = 0.2;
	elasticity = 0.2;
...
datablock ShapeBaseImageData(ColtNavyImage)
{
   // Basic Item properties
   shapeFile = "./ColtNavy.dts";
   emap = true;
...
function ColtNavyImage::onFire(%this, %obj, %slot)
{
	MMGunImage::onFire(%this, %obj, %slot);
}

function ColtNavyImage::onReady(%this,%obj,%slot)
{
	MMGunImage::onReady(%this, %obj, %slot);
}

function ColtNavyImage::onReloaded(%this, %obj, %slot)
{
	MMGunImage::onReloaded(%this, %obj, %slot);
}

function ColtNavyImage::onReloadStart(%this, %obj, %slot)
{
	MMGunImage::onReloadStart(%this, %obj, %slot);
}

function ColtNavyImage::onReloadMid(%this, %obj, %slot)
{
