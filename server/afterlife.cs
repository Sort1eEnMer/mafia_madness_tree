...
function Camera::setSpecPlayer(%this, %cl, %specCl)
{
	...
	%cl.bottomPrint("\c5Spectating:\c6" SPC %specCl.getSimpleName() @ "<just:right>\c5ROLES\c6 (" @ getMiniGameFromObject(%specCl).MM_GetNumPlayers() @ "):" SPC MM_ColourCodeRoles(%cl.minigame.MM_getRolesList()) @ " " NL %str);
}
